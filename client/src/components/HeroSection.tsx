  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full">
        ...
        >
          <h1 className="text-[clamp(1.5rem,3.5vw,3rem)] font-normal leading-[1.1] tracking-[-0.01em] text-foreground max-w-2xl" style={{ fontFamily: "'Radley', 'Hannari', serif", color: "#494949", whiteSpace: "pre-line" }}>
            {t(
