      ...
      >
        ...
        <p className="mt-8 md:mt-12 text-sm leading-[1.8]" style={{ color: "#666666" }}>
          {t(
            ...
            <><strong>Sovereign Technology [ソブリンテクノロジー]</strong> — 使う人の自由や主権を守るための技術。オープンソースで、仕組みが透明で、誰でも検証できる。使い手が個人であれ、コミュニティであれ、国家であれ、寄り添うもの。Pala Labsはこの技術と文化、社会をつなぎ、このムーブメントの中から本当に価値あるものを選び、ツール、教育、コミュニティという形で発信します。</>
          )}
        </p>
        <a
          href="/work"
